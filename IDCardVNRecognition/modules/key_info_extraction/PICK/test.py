...
import time
from modules.utils.visualize import viz_output_of_pick
from modules.key_info_extraction.create_train_data import create_data_pick_boxes_and_transcripts
from modules.config import cls_out_txt_dir, kie_boxes_transcripts, kie_model, \
