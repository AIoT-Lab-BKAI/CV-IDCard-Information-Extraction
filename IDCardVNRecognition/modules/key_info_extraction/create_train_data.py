...
import numpy as np
from modules.utils.common import IoU, cer_loss_one_image, type_map, \
    color_map,get_list_gt_poly, get_list_icdar_poly, get_list_file_in_folder, euclidean_distance
from modules.utils.spell_check import validate_SELLER, validate_TOTAL_COST_amount, \
...
if __name__ == '__main__':
    from modules.config import filtered_csv, cls_out_txt_dir, kie_out_txt_dir, \
    ...
    # from modules.utils.visualize import viz_icdar_multi
