...
from modules.rotation_corrector.utils.loader import get_img_paths, NewPad
from modules.rotation_corrector.utils.core import ClsPostProcess
from modules.rotation_corrector.utils.utils import rotate_image_angle
from modules.rotation_corrector.model.mobilenetv3 import mobilenetv3 as model
...
class CheckQuality:
    ...
    def inference(self, image, debug=False):
        ...
        x = x.view(1, 3, self.imH, self.imW)    # batchsize, c, h, w
        x.unsqueeze(0)
...
def predict_ud(visualize=False):
    ...
    weight_path = "/home/ntanh/ntanh/MC_OCR/modules/rotation_corrector/save_dir/mobilenetv3/train_20210105-1747/" \
