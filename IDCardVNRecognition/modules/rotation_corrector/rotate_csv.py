...
from modules.rotation_corrector.inference import get_list_boxes_from_icdar, calculate_page_orient
from modules.rotation_corrector.filter import drop_box, get_mean_horizontal_angle
from modules.rotation_corrector.predict import init_box_rectify_model
from modules.config import rot_model_path, det_out_txt_dir
...
if __name__ == '__main__':
    from modules.config import filtered_train_img_dir, filtered_csv, rotate_filtered_csv
