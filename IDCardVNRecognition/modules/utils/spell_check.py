...
from modules.utils.common import cer_loss_one_image
...
def fix_totalcost(list_totalcost, output_ocr_path = None):
    from modules.utils.common import cer_loss_one_image, get_list_icdar_poly
    from modules.key_info_extraction.create_train_data import find_TOTALCOST_val_poly
    final_list = []
