...
import cv2, os, csv
from modules.utils.common import poly, get_list_file_in_folder, get_list_gt_poly, type_map
...
if __name__ == '__main__':
    ...
    # list_path = '/home/cuongnd/PycharmProjects/modules/modules/submit/mc_ocr_private_test/check_coopmart.txt'
    #
    ...
    # submit_file = '/home/cuongnd/PycharmProjects/aicr/modules/submit/private_test/results.csv'
    # img_dir = '/data20.04/data/MC_OCR/output_results/key_info_extraction/private_test_pick/output/viz_imgs'
    # list_path = '/home/cuongnd/PycharmProjects/aicr/modules/submit/check_sort_time.txt'
