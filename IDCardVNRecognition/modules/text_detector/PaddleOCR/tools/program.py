...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument("-c", "--app", help="configuration file to use")
        self.add_argument(
    ...
    def parse_args(self, argv=None):
        ...
        assert args.config is not None, \
            "Please specify --app=configure_file_path."
...
def load_config(file_path):
    """
    Load app from yml/yaml file.
    Args:
        file_path (str): Path of the app file to be loaded.
    Returns: global app
    """
...
def check_gpu(use_gpu):
    ...
    err = "Config use_gpu cannot be set as true while you are " \
          ...
          "\t2. Set use_gpu as false in app file to run " \
          "model on CPU"
...
def preprocess(is_train=False):
    ...
    if is_train:
        ...
        with open(os.path.join(save_model_dir, 'app.yml'), 'w') as f:
            yaml.dump(
