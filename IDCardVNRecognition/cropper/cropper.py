...
class Cropper:
    ...
    def process(self, image) -> object:
        ...
        warped = None
        if img_0_is_chosen and self.points is not None:
            warped = align_image(image_0, self.points)
        elif img_90_is_chosen and self.points is not None:
            warped = align_image(image_90, self.points)
        elif img_180_is_chosen and self.points is not None:
            warped = align_image(image_180, self.points)
        elif img_270_is_chosen and self.points is not None:
